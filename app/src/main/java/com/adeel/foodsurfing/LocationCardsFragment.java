...
public class LocationCardsFragment extends Fragment {
    ...
    public LocationCardsFragment() {
        // Required empty public constructor
    }
    // TODO: Rename and change types and number of parameters
    public static LocationCardsFragment newInstance() {
        LocationCardsFragment fragment = new LocationCardsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_location_cards, container,false);
    ...
    private void setupViewPager(final ViewPager viewPager) {
        ...
        adapter.addFragment(new CardsTabFragment(), "Gastronomiebetriebe");
        adapter.addFragment(new LocationTabFragment(), "Karte");
